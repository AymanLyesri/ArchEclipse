...
export default function QuickApps({
  ...
  function normalizeQuickAppHistory(entries: unknown): string[] {
  ...
  function sortQuickAppsByHistory(entries: string[]): LauncherApp[] {
  ...
  function persistQuickAppHistory(entries: string[]) {
