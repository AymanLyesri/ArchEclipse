...
Item {
    ...
    function isInArray(arr, img) {
        if (!img) return false
        // AGS getBookmarkKey: id + api match (same id can exist per API)
    ...
    function onBookmarkToggled(exitOk, stdoutText) {
        ...
        try {
            ...
            if (root.selectedTab === "Bookmarks") root.loadBookmarks()
        } catch (e) {
            Settings.reload()
    ...
    Component {
        ...
        Process {
            ...
            onExited: (code) => root.onBookmarkToggled(code === 0, out)
        }
    }
        ...
        Rectangle {
            ...
            Column {
                ...
                Flow {
                    ...
                    clip: true
                    Repeater {
                        model: root.dialogImage && root.dialogImage.tags ? root.dialogImage.tags.slice(0, 10) : []
                        delegate: Rectangle {
